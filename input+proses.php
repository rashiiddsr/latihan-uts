...
<body>
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <table> 
            ...
            <tr>
                <td></td>
                <td><input type="submit" name="submit_button" value="Proses">&nbsp<input type="submit" name="reset_button" value="Batal"></td>
                <td></td>
            </tr>
        </table>
    </form>
        <br><br>
    <?php
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['reset_button'])) {
        ?>
    ...
    <?php
        } else if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_button'])) {
